...
#pragma warning restore 649
        ...
        protected virtual void SetContentAnchoredPosition(Vector2 position)
        {
            ...
            {
                // Debug.LogError($"SetContentAnchoredPosition {position}");
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (deltaTime > 0.0f)
            {
                ...
                if (m_Dragging && m_Inertia)
                {
                    ...
                    // Debug.LogError($"newVelocity {newVelocity}; pos {m_Content.anchoredPosition} prev {m_PrevPosition}");
        ...
        protected virtual void SetNormalizedPosition(float value, int axis)
        {
            ...
            if (Mathf.Abs(anchoredPosition[axis] - newAnchoredPosition) > 0.01f)
            {
                ...
                // Debug.LogError($"SetNormalizedPosition {anchoredPosition}");
                m_Velocity[axis] = 0;
                UpdateBounds();
            }
        }
