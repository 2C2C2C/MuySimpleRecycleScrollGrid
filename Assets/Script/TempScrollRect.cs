...
/*
 * TODO @hiko 
 * deal with elstic, add speed for scrolling
 * 
 */

namespace HikoShit.UI
{
    [AddComponentMenu("UI/Temp Scroll Rect")]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class TempScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        #region enum define
        ...
        public virtual void OnScroll(PointerEventData data)
        {
            ...
            m_OnValueChangedDelta?.Invoke(delta * m_ScrollSensitivity * m_ViewRect.rect.height * 0.1f);
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (true || MovementType.Clamped == m_MovementType)
            {
                ...
                m_OnValueChangedDelta.Invoke(currentDelta * m_ScrollSensitivity);
            }
            else
            {
                FakeMoveContent();
        ...
        private Vector2 m_contentMoveSpeed = default;
        private void FakeMoveContent()
        {
            // this is for elastic to move 
        }
        ...
        private void UpdateScrollbars(Vector2 offset)
        {
            ...
            // TODO @Hiko use real data content len for scrollbar
            if (m_VerticalScrollbar)
            {
